                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            {if $usuario->getCorreo() == "admin@prueba.com"}
                                        ...
                                        <tr class="fila_archivo">
                                            ...
                                            {if $usuario->getCorreo() =="admin@prueba.com"}
                                            <td><button onclick="window.location = '{$url_eliminar_archivo}{$archivo->getId ()}'" class="btn btn-default btn-xs"><span class="fa fa-close"></span></td>{/if}
                                            </tr>
                                            {/foreach}
                                        </tbody>
                                    </table>
